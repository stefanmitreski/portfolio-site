  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl flex flex-col gap-12">
        {/* Experience Card */}
        <div className="bg-white dark:bg-[#181c20] rounded-2xl shadow-lg p-6 sm:p-8 mb-4 flex flex-col items-start border border-gray-100 dark:border-gray-800 w-full">
          <h3 className="text-2xl sm:text-3xl font-semibold text-blue-700 dark:text-blue-300 mb-2">Experience</h3>
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full">
          {/* Project 1 */}
          <div className="flex-1 bg-white dark:bg-[#181c20] rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100 dark:border-gray-800 flex flex-col min-w-0 mb-6 md:mb-0">
            <h4 className="text-xl sm:text-2xl font-semibold text-blue-700 dark:text-blue-300 mb-2">Media/Advertising Domain</h4>
          ...
          {/* Project 2 */}
          <div className="flex-1 bg-white dark:bg-[#181c20] rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100 dark:border-gray-800 flex flex-col min-w-0">
            <h4 className="text-xl sm:text-2xl font-semibold text-blue-700 dark:text-blue-300 mb-2">Sports Betting Domain</h4>
            <p className="text-gray-700 dark:text-gray-200 mb-2 text-base sm:text-lg">
